const quotes = {
    "- Fayez Erum": '"The Way Get Started Is To Quit Talking And Begin Doing."',
    ...
    "- Sanchi Joshi": '"Strive not to be a success, but rather to be of value."',
    "- Anuj Bhagat": '"I attribute my success to this: I never gave or took any excuse."',
